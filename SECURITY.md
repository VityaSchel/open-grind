...
- Supply chain — signing keys, CI, dependency pinning, and anything that breaks the reproducibility of a published release ([BUILDING.md](./BUILDING.md#verifying-a-published-release), [KEYS.md](./KEYS.md))
