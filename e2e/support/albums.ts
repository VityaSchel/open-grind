...
export const SHARED_ALBUM = `a[data-slot="album-tile"][href="/albums/${SHARED_ALBUM_ID}"]`;
export const TWO_ROW_ALBUM_ID = 902;
export const TWO_ROW_ALBUM = `a[data-slot="album-tile"][href="/albums/${TWO_ROW_ALBUM_ID}"]`;
