...
: "${OPEN_GRIND_HETZNER_API_TOKEN:?}" "${OPEN_GRIND_SCALEWAY_ACCESS_KEY:?}"
: "${OPEN_GRIND_SCALEWAY_SECRET_KEY:?}" "${OPEN_GRIND_SCALEWAY_PROJECT_ID:?}"

OPEN_GRIND_FORGEJO_TOKEN="$(trim "$OPEN_GRIND_FORGEJO_TOKEN")"
# OPEN_GRIND_CHERRY_API_TOKEN="$(trim "$OPEN_GRIND_CHERRY_API_TOKEN")" # with boxes a/b enabled
# OPEN_GRIND_VULTR_API_KEY="$(trim "$OPEN_GRIND_VULTR_API_KEY")" # with boxes a/b enabled
OPEN_GRIND_HETZNER_API_TOKEN="$(trim "$OPEN_GRIND_HETZNER_API_TOKEN")"
OPEN_GRIND_SCALEWAY_ACCESS_KEY="$(trim "$OPEN_GRIND_SCALEWAY_ACCESS_KEY")"
