...
| ------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `build.yml`  | manual               | Builds the Android APK (`nix run .#build-android`), the x86_64 and arm64 Linux `.deb` ([linux/](./linux)) and both Windows installers ([windows/](./windows)) on several providers, compares the results (`verify.ts`) |
